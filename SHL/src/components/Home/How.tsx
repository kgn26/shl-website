    ...
    return (
        <div className="how-container">
            ...
            <div className="card-container">
                <div className={scrollElt ? "how-card tilt-left card-top animate__animated animate__fadeInUp animate__delay__second" : "how-card tilt-left card-top hide"}>
                ...
                <div className={scrollElt ? "how-card tilt-right card-mid animate__animated animate__fadeInUp animate__delay__first" : "how-card tilt-right card-top hide"}>
